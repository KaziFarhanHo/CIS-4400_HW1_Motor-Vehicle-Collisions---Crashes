...
CREATE TABLE cis4400.DateDimension (
...
CREATE TABLE cis4400.IncidentsFact (
...
INSERT INTO cis4400.DateDimension (DateKey, Date, Year, Quarter, Month, Day, WeekdayName)
...
INSERT INTO cis4400.IncidentsFact (IncidentKey, DateKey, SomeMeasure, OtherMeasure)
VALUES (GENERATE_UUID(), (SELECT DateKey FROM cis4400.DateDimension WHERE Date = '2023-10-01'), 100, 200);
